...
var favorite_Fruit=["banana","apple","orange","KIWI"]
console.log(favorite_Fruit)

for(var i=0;i<favorite_Fruit.length;i++)
{
    if(favorite_Fruit[i].toLowerCase()=='banana')
    {
        console.log(`You love ${favorite_Fruit[i]}`)
    }
    else if(favorite_Fruit[i].toLowerCase()=='apple')
    {
        console.log(`You love ${favorite_Fruit[i]}`)
    }
    else if(favorite_Fruit[i].toUpperCase()=='ORANGE')
    {
        console.log(`You love ${favorite_Fruit[i]}`)
    }
    else
    {
        console.log(`${favorite_Fruit[i]} IS NOT IN YOUR LIST`)
    }
}
